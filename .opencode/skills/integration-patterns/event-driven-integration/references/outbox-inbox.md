...
CREATE TABLE outbox_event (
    ...
    integration_event_name VARCHAR(255) NOT NULL,
...
class InventoryReservationHandler:
    ...
    async def handle(self, order_confirmed_event: OrderConfirmedEvent) -> None:
        async with self._unit_of_work as unit_of_work:
            if await unit_of_work.inbox.contains(order_confirmed_event.event_id):
