...
def extract_method(content: str, method_name: str) -> tuple[int, int, str, list[str], list[str]] | None:
...
def build_method(method_name: str, return_type: str, params: list[str], body_lines: list[str]) -> str:
