...
from shell.messaging.domain.messaging.aggregates.message_router.events.message_router_created_event import (
    MessageRouterCreatedEvent,
)
from shell.messaging.domain.messaging.aggregates.message_router.events.message_router_deleted_event import (
    MessageRouterDeletedEvent,
)
from shell.messaging.domain.messaging.aggregates.message_router.events.message_router_updated_event import (
