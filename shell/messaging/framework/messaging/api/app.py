...
from shell.messaging.framework.messaging.message_router.api.router import router
...
def create_messaging_app(container: ContainerProtocol) -> FastAPI:
    app = FastAPI(title="shell - messaging", version="0.1.0")
