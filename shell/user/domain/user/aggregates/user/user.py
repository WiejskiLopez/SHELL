...
from shell.user.domain.user.aggregates.user.events.user_created_event import UserCreatedEvent
from shell.user.domain.user.aggregates.user.events.user_deleted_event import UserDeletedEvent
from shell.user.domain.user.aggregates.user.events.user_updated_event import UserUpdatedEvent
