...
from shell.user.domain.user.aggregates.user_state.events.user_state_deleted_event import (
    UserStateDeletedEvent,
)
from shell.user.domain.user.aggregates.user_state.events.user_state_updated_event import (
