...
if TYPE_CHECKING:
    from shell.user.application.user.user_state.dto.user_state import UserStateDto
    from shell.user.application.user.user_state.ports.user_state_query_service import (
        UserStateQueryService,
    )
    from shell.user.application.user.user_state.queries.get_user_state_by_id_query import (
