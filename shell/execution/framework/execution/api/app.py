...
from shell.execution.framework.execution.edge_execution.api.router import (
    router as edge_executions_router,
)
from shell.execution.framework.execution.edge_link_execution.api.router import (
    router as edge_link_executions_router,
)
from shell.execution.framework.execution.node_execution.api.router import (
    router as node_execution_router,
)
from shell.execution.framework.execution.task_execution.api.router import (
