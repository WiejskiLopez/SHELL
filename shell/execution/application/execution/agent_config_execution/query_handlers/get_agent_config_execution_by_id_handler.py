...
if TYPE_CHECKING:
    ...
    from shell.execution.application.execution.agent_config_execution.ports.agent_config_execution_query_service import (
        AgentConfigExecutionQueryService,
    )
    from shell.execution.application.execution.agent_config_execution.queries.get_agent_config_execution_by_id_query import (
