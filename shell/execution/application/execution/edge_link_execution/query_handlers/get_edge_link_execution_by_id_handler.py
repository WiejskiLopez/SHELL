...
if TYPE_CHECKING:
    from shell.execution.application.execution.edge_link_execution.dto.edge_link_execution import (
        EdgeLinkExecutionDto,
    )
    from shell.execution.application.execution.edge_link_execution.ports.edge_link_execution_query_service import (
