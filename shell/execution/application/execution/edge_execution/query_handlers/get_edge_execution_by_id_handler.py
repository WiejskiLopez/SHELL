...
if TYPE_CHECKING:
    from shell.execution.application.execution.edge_execution.dto.edge_execution import (
        EdgeExecutionDto,
    )
    from shell.execution.application.execution.edge_execution.ports.edge_execution_query_service import (
