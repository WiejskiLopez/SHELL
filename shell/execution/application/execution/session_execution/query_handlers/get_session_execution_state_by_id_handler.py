...
if TYPE_CHECKING:
    from shell.execution.application.execution.session_execution.dto.session_execution_state import (
        SessionExecutionStateDto,
    )
    from shell.execution.application.execution.session_execution.ports.session_execution_state_query_service import (
        SessionExecutionStateQueryService,
    )
    from shell.execution.application.execution.session_execution.queries.get_session_execution_state_by_id_query import (
