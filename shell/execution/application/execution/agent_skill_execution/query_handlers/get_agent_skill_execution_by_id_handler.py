...
if TYPE_CHECKING:
    from shell.execution.application.execution.agent_skill_execution.dto.agent_skill_execution import (
        AgentSkillExecutionDto,
    )
    from shell.execution.application.execution.agent_skill_execution.ports.agent_skill_execution_query_service import (
        AgentSkillExecutionQueryService,
    )
    from shell.execution.application.execution.agent_skill_execution.queries.get_agent_skill_execution_by_id_query import (
