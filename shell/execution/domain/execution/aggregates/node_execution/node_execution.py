...
from shell.execution.domain.execution.aggregates.node_execution.events.node_execution_deleted_event import (
    NodeExecutionDeletedEvent,
)
from shell.execution.domain.execution.aggregates.node_execution.events.node_execution_updated_event import (
