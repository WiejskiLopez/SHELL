...
from shell.execution.domain.execution.aggregates.session_execution_state.events.session_execution_state_created_event import (
    SessionExecutionStateCreatedEvent,
)
from shell.execution.domain.execution.aggregates.session_execution_state.events.session_execution_state_deleted_event import (
    SessionExecutionStateDeletedEvent,
)
from shell.execution.domain.execution.aggregates.session_execution_state.events.session_execution_state_updated_event import (
...
if TYPE_CHECKING:
    ...
    from shell.execution.domain.execution.aggregates.session_execution_state.value_objects.session_execution_state_id import (
