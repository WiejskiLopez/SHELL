...
from shell.execution.domain.execution.aggregates.workflow.value_objects.node_execution_result_id import (
...
if TYPE_CHECKING:
    ...
    from shell.execution.domain.execution.aggregates.workflow.value_objects.artifact_uri import (
        ArtifactUri,
    )
    from shell.execution.domain.execution.aggregates.workflow.value_objects.execution_stderr import (
        ExecutionStderr,
    )
    from shell.execution.domain.execution.aggregates.workflow.value_objects.execution_stdout import (
        ExecutionStdout,
    )
