...
from shell.execution.domain.execution.aggregates.user_execution.events.user_execution_created_event import (
    UserExecutionCreatedEvent,
)
from shell.execution.domain.execution.aggregates.user_execution.events.user_execution_deleted_event import (
    UserExecutionDeletedEvent,
)
from shell.execution.domain.execution.aggregates.user_execution.events.user_execution_updated_event import (
...
if TYPE_CHECKING:
    from shell.execution.domain.execution.aggregates.user_execution.value_objects.user_id_ref import (
        UserIdRef,
    )
