...
from shell.execution.domain.execution.aggregates.session_execution.events.session_execution_deleted_event import (
    SessionExecutionDeletedEvent,
)
from shell.execution.domain.execution.aggregates.session_execution.events.session_execution_updated_event import (
