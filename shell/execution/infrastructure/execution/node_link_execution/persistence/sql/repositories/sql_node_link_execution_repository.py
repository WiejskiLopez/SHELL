...
from shell.execution.infrastructure.execution.node_link_execution.persistence.sql.mappers import (
    node_link_execution_entity_to_model,
    node_link_execution_model_to_entity,
)
from shell.execution.infrastructure.execution.node_link_execution.persistence.sql.models import (
...
if TYPE_CHECKING:
    ...
    from shell.execution.domain.execution.aggregates.node_link_execution.node_link_execution import (
        NodeLinkExecution,
    )
