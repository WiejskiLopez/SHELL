...
from shell.execution.infrastructure.execution.session_execution_state.persistence.sql.mappers import (
...
if TYPE_CHECKING:
    ...
    from shell.execution.domain.execution.aggregates.session_execution_state.session_execution_state import (
