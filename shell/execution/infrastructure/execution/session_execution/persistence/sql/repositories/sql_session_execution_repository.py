...
from shell.execution.infrastructure.execution.session_execution.persistence.sql.mappers import (
...
if TYPE_CHECKING:
    ...
    from shell.execution.domain.execution.aggregates.session_execution import SessionExecution
