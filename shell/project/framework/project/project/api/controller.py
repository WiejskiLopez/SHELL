...
from shell.project.application.project.project.queries.list_projects_query import (
    ListProjectsQuery,
)
from shell.project.framework.project.project.api.create_project_request import (
    CreateProjectRequest as ApiCreateProjectRequest,
)
from shell.project.framework.project.project.api.create_project_response import (
    CreateProjectResponse as ApiCreateProjectResponse,
)
from shell.project.framework.project.project.api.project_response import (
    ProjectResponse as ApiProjectResponse,
)
from shell.project.framework.project.project.api.update_project_request import (
    UpdateProjectRequest as ApiUpdateProjectRequest,
)

if TYPE_CHECKING:
    from shell.project.application.project.project.dto.project import ProjectDto
