...
from shell.project.domain.project.aggregates.project_skill.events.project_skill_created_event import (
    ProjectSkillCreatedEvent,
)
from shell.project.domain.project.aggregates.project_skill.events.project_skill_deleted_event import (
    ProjectSkillDeletedEvent,
)
from shell.project.domain.project.aggregates.project_skill.events.project_skill_updated_event import (
    ProjectSkillUpdatedEvent,
)
from shell.project.domain.project.aggregates.project_skill.value_objects.project_skill_data import (
    ProjectSkillData,
)
