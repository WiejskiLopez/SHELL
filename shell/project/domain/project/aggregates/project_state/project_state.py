...
from shell.project.domain.project.aggregates.project_state.events.project_state_changed_event import (
    ProjectStateChangedEvent,
)
from shell.project.domain.project.aggregates.project_state.events.project_state_deleted_event import (
    ProjectStateDeletedEvent,
)
from shell.project.domain.project.aggregates.project_state.events.project_state_updated_event import (
