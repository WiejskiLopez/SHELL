...
from shell.domain.execution.value_objects.ids.graph_node_execution_input_payload_id import GraphNodeExecutionInputPayloadId
from shell.domain.execution.value_objects.ids.graph_node_execution_output_payload_id import GraphNodeExecutionOutputPayloadId
from shell.domain.execution.value_objects.ids.graph_node_execution_result_id import GraphNodeExecutionResultId
from shell.domain.execution.value_objects.ids.graph_node_execution_state_id import GraphNodeExecutionStateId
from shell.domain.execution.value_objects.ids.graph_node_transition_execution_id import GraphNodeTransitionExecutionId
...
from shell.domain.execution.value_objects.ids.task_execution_input_payload_id import TaskExecutionInputPayloadId
from shell.domain.execution.value_objects.ids.task_execution_output_payload_id import TaskExecutionOutputPayloadId
