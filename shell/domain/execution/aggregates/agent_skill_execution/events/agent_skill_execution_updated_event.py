...
class AgentSkillExecutionUpdatedEvent(DomainEvent):
    agentskillexecution_id: AgentSkillExecutionId

    @classmethod
    def now(cls, agentskillexecution_id: AgentSkillExecutionId, now: CreatedAt) -> AgentSkillExecutionUpdatedEvent:
