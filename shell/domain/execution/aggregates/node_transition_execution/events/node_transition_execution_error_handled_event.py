...
class NodeTransitionExecutionErrorHandledEvent(DomainEvent):
    ...
    def from_payload(
        ...
        return cls(
            ...
            failed_node_id=NodeExecutionId(payload["failed_node_id"]),
            handler_node_id=NodeExecutionId(payload["handler_node_id"]),
        )
