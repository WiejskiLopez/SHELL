...
from shell.domain.messaging.aggregates.message_router.value_objects.message_data import (  # noqa: TC001 -- needed at runtime for deserialization type resolution
    MessageData,
)
