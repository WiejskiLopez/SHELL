...
* `shell/domain/entities/workflow.py`
* `shell/domain/services/node_navigator.py`
* `shell/domain/services/node_execution_policy.py`
* `shell/domain/services/compensation_handler.py`
* `shell/application/event_handlers/node_execution_worker.py`
* `shell/infrastructure/persistence/sql/repositories/__init__.py`
* `shell/docs/dokumentacja/workflow-execution-flow.md`
