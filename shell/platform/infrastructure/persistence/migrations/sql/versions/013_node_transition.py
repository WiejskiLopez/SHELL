"""Phase 21 — add node_transition table for edge-based orchestration.

Revision ID: 013
Revises: 012
Create Date: 2026-06-19

* Create ``node_transition`` table — defines transitions between graph nodes.
"""
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(36),
            sa.ForeignKey("node_execution.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
