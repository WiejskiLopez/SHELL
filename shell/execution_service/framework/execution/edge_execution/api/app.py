"""FastAPI application factory — EdgeExecution aggregate."""
...
from shell.execution_service.framework.execution.edge_execution.api.router import router
...
def create_edge_execution_app(container: ContainerProtocol) -> FastAPI:
    """Tworzy aplikację FastAPI dla agregatu EdgeExecution.

    Może być używana jako samodzielny mikroserwis lub jako część BC Execution.
    """
    app = FastAPI(title="shell — execution:edge_execution", version="0.1.0")
