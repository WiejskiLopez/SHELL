"""FastAPI application factory — NodeExecution aggregate."""
...
from shell.execution_service.framework.execution.node_execution.api.router import router
...
def create_node_execution_app(container: ContainerProtocol) -> FastAPI:
    """Tworzy aplikację FastAPI dla agregatu NodeExecution.

    Może być używana jako samodzielny mikroserwis lub jako część BC Execution.
    """
    app = FastAPI(title="shell — execution:node_execution", version="0.1.0")
