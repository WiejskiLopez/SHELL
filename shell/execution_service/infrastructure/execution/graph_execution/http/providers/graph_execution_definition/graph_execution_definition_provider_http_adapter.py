...
from shell.execution_service.domain.execution.aggregates.graph_execution.ports.graph_execution_definition_provider import (
    GraphExecutionDefinitionProvider,
)
from shell.execution_service.infrastructure.execution.graph_execution.http.providers.graph_execution_definition.contracts.v1.graph_definition_response import (
    GraphDefinitionResponseV1,
)
from shell.execution_service.infrastructure.execution.graph_execution.http.providers.graph_execution_definition.mappers.graph_definition_response_to_domain import (
...
class GraphExecutionDefinitionProviderHttpAdapter(GraphExecutionDefinitionProvider):
    ...
    async def get_graph_definition(self, definition_id: str) -> GraphDefinitionReference | None:
