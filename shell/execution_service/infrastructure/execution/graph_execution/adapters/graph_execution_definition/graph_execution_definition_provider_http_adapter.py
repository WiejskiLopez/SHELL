...
from shell.execution_service.infrastructure.execution.graph_execution.adapters.graph_execution_definition.mappers.graph_definition_response_to_domain import (
