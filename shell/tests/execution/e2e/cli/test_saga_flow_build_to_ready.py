...
class TestSagaFlowBuildToReady:
    async def test_full_flow_with_two_nodes(
        ...
        # ── 3. Saga: create saga → fetch linked node defs → publish CreateGraphNodeExecutionCommand ──
        ...
        link_def_repo = unit_of_work.repository(InMemoryGraphNodeLinkDefinitionRepository)
        node_def_repo = unit_of_work.repository(InMemoryGraphNodeDefinitionRepository)
        ...
        link_exec_repo = unit_of_work.repository(InMemoryGraphNodeLinkExecutionRepository)
