...
class TestNodeExecutionResultHandlerHappyPath:
    async def test_completed_advances_to_next_node(self) -> None:
        ...
        assert NodeExecutionAdvancedEvent in types
        assert NodeExecutionRequestedEvent in types
...
class TestNodeExecutionResultHandlerFailure:
    async def test_failed_aborts_under_fail_fast_policy(self) -> None:
        ...
        assert NodeExecutionAdvancedEvent not in types
        assert NodeExecutionRequestedEvent not in types


class TestNodeExecutionResultHandlerIdempotency:
