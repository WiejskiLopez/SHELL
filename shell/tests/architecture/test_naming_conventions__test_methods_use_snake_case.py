...
def test_methods_use_snake_case() -> None:
    ...
    assert not violations, architecture_assertion_message('reguła testowana przez test_methods_use_snake_case', 'warunek zapisany w asercji musi być spełniony', 'Functions/methods must use snake_case:\n' + '\n'.join(violations))
