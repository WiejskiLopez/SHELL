"""Koncept: reguła architektoniczna dotycząca enterprise patterns: test all aggregates have factory.

Reguła: test sprawdza kontrakt architektoniczny enterprise patterns: test all aggregates have factory.
