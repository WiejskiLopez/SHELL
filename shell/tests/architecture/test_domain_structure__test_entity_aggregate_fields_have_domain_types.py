...
def test_entity_aggregate_fields_have_domain_types() -> None:
    ...
    assert not violations, architecture_assertion_message(
        "reguła testowana przez test_entity_aggregate_fields_have_domain_types",
        "warunek zapisany w asercji musi być spełniony",
        "Entity/Aggregate fields must use domain types (ValueObject, Entity, etc.), not primitive types. Wrap bare str/int/bool/dict/list in a ValueObject:\n"
        + "\n".join(violations),
    )
