"""Koncept: reguła architektoniczna dotycząca domain structure: test no public setters.

Reguła: test sprawdza kontrakt architektoniczny domain structure: test no public setters.
...
def test_no_public_setters() -> None:
    ...
    assert not violations, architecture_assertion_message('reguła testowana przez test_no_public_setters', 'warunek zapisany w asercji musi być spełniony', 'Entities/AggregateRoots must not have public setters:\n' + '\n'.join(violations))
