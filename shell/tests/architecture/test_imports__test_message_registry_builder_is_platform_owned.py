...
def test_message_registry_builder_is_platform_owned() -> None:
    ...
    assert platform_registry.exists(), architecture_assertion_message(
        "reguła testowana przez test_message_registry_builder_is_platform_owned",
        "warunek zapisany w asercji musi być spełniony",
        "Message registry builder must remain in platform",
    )
    assert not bc_registry.exists(), architecture_assertion_message(
        "reguła testowana przez test_message_registry_builder_is_platform_owned",
        "warunek zapisany w asercji musi być spełniony",
        "Message registry must not be duplicated inside Ingestion BC",
    )
