...
def test_init_py_does_not_rexport_stdlib() -> None:
    ...
    assert not violations, architecture_assertion_message('reguła testowana przez test_init_py_does_not_rexport_stdlib', 'warunek zapisany w asercji musi być spełniony', '\n'.join(violations))
