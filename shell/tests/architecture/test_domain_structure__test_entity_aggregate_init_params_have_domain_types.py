"""Koncept: reguła architektoniczna dotycząca domain structure: test entity aggregate init params have domain types.

Reguła: test sprawdza kontrakt architektoniczny domain structure: test entity aggregate init params have domain types.
                ...
                for arg in stmt.args.args:
                    ...
                    if primitive:
                        ...
                        if key in _KNOWN_INIT_PARAM_VIOLATIONS:
                            continue
                        violations.append(key)
    assert not violations, architecture_assertion_message('reguła testowana przez test_entity_aggregate_init_params_have_domain_types', 'warunek zapisany w asercji musi być spełniony', 'Entity/Aggregate __init__/restore parameters must use domain types (ValueObject, Entity, etc.), not primitive types. Wrap bare str/int/bool/dict/list/datetime in a ValueObject:\n' + '\n'.join(violations))
