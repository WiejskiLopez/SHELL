...
class TestFrameworkDoesNotUseQueryServices:
    ...
    def test_no_query_service_import_in_framework(self) -> None:
        ...
        assert not violations, architecture_assertion_message('reguła testowana przez test_no_query_service_import_in_framework', 'warunek zapisany w asercji musi być spełniony', 'Framework imports QueryService (must dispatch via QueryBus):\n' + '\n'.join(violations))
