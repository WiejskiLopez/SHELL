"""Koncept: reguła architektoniczna dotycząca naming conventions: test classes use pascal case.

Reguła: test sprawdza kontrakt architektoniczny naming conventions: test classes use pascal case.
...
def test_classes_use_pascal_case() -> None:
    ...
    assert not violations, architecture_assertion_message('reguła testowana przez test_classes_use_pascal_case', 'warunek zapisany w asercji musi być spełniony', 'All classes must use PascalCase:\n' + '\n'.join(violations))
