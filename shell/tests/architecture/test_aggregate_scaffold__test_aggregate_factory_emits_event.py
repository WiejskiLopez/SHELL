"""Koncept: reguła architektoniczna dotycząca aggregate scaffold: test aggregate factory emits event.

Reguła: test sprawdza kontrakt architektoniczny aggregate scaffold: test aggregate factory emits event.
