...
def test_domain_does_not_import_datetime() -> None:
    ...
    assert not violations, architecture_assertion_message(
        "reguła testowana przez test_domain_does_not_import_datetime",
        "warunek zapisany w asercji musi być spełniony",
        "Domain layer must not import datetime. Use CreatedAt/ChangedAt/DeletedAt value objects instead.\n"
        + "\n".join(violations),
    )
