"""Koncept: reguła architektoniczna dotycząca cross aggregate discipline: test command handlers dont use cross bc repos.

Reguła: test sprawdza kontrakt architektoniczny cross aggregate discipline: test command handlers dont use cross bc repos.
