...
class TestEveryQueryIsPublishedToTheBus:
    ...
    def test_all_queries_are_registered(self) -> None:
        ...
        assert not missing, architecture_assertion_message('reguła testowana przez test_all_queries_are_registered', 'warunek zapisany w asercji musi być spełniony', 'Queries defined but never published to a QueryBus (query_bus.register missing):\n' + '\n'.join(missing))
