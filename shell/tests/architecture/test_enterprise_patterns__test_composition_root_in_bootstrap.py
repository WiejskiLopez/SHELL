...
def test_composition_root_in_bootstrap() -> None:
    ...
    assert container_files or factory_files or (not missing), architecture_assertion_message('reguła testowana przez test_composition_root_in_bootstrap', 'warunek zapisany w asercji musi być spełniony', 'bootstrap/ should contain Container or Factory files for DI composition:\n' + '\n'.join(missing))
