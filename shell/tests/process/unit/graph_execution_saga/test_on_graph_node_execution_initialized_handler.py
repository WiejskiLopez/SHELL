"""Unit tests for OnGraphNodeExecutionInitializedHandler."""
...
class TestOnGraphNodeExecutionInitializedHandler:
    ...
    def handler(
        ...
        return OnGraphNodeExecutionInitializedHandler(
    ...
    async def test_records_node_and_publishes_attach_when_complete(
        self,
        handler: OnGraphNodeExecutionInitializedHandler,
        saga_manager: GraphExecutionSagaManager,
