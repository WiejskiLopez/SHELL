"""Phase fix — rename node_result to node_execution_result.

Revision ID: 020
Revises: 019
Create Date: 2026-06-20

Drop the legacy ``node_result`` table and create ``node_execution_result``
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_node_execution_result_node_execution_id",
        "node_execution_result",
        ["node_execution_id"],
    )
    op.create_index(
        "ix_node_execution_result_workflow_id",
        "node_execution_result",
        ["workflow_id"],
    )
