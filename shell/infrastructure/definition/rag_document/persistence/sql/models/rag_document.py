...
if TYPE_CHECKING:
    from shell.infrastructure.definition.rag_document.persistence.sql.models.rag_chunk import (  # noqa: E402 — łamie circular import RagDocumentModel ↔ RagChunkModel
