...
from shell.infrastructure.persistence.memory.fake_clock import FakeClock
from shell.infrastructure.persistence.memory.fake_id_generator import FakeIdGenerator
from shell.infrastructure.persistence.memory.fake_event_publisher import FakeEventPublisher
from shell.infrastructure.persistence.memory.fake_logger import FakeLogger
from shell.infrastructure.persistence.memory.fake_task_loader import FakeTaskLoader
from shell.infrastructure.persistence.memory.fake_node_process_runner import FakeNodeProcessRunner
from shell.infrastructure.persistence.memory.fake_node_workspace import FakeNodeWorkspace
from shell.infrastructure.persistence.memory.in_memory_query_services import InMemoryQueryServices
...
from shell.infrastructure.persistence.memory.in_memory_graph_node_definition_repository import InMemoryGraphNodeDefinitionRepository
