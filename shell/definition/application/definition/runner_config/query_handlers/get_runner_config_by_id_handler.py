...
if TYPE_CHECKING:
    from shell.definition.application.definition.runner_config.dto.runner_config import (
        RunnerConfigDto,
    )
    from shell.definition.application.definition.runner_config.ports.runner_config_query_service import (
