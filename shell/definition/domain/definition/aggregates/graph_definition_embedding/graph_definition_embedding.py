...
from shell.definition.domain.definition.aggregates.graph_definition_embedding.events.graph_definition_embedding_deleted_event import (
    GraphDefinitionEmbeddingDeletedEvent,
)
from shell.definition.domain.definition.aggregates.graph_definition_embedding.events.graph_definition_embedding_updated_event import (
    GraphDefinitionEmbeddingUpdatedEvent,
)
from shell.definition.domain.definition.aggregates.graph_definition_embedding.value_objects.embedding_text import (
    EmbeddingText,
)
...
if TYPE_CHECKING:
    ...
    from shell.definition.domain.definition.aggregates.graph_definition_embedding.value_objects.embedding import (
        Embedding,
    )
    from shell.definition.domain.definition.aggregates.graph_definition_embedding.value_objects.embedding_model import (
        EmbeddingModel,
    )


from shell.definition.domain.definition.aggregates.graph_definition_embedding.events.graph_definition_embedding_created_event import (
