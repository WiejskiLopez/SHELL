...
from shell.ingestion.domain.ingestion.aggregates.ingestion.value_objects.ingestion_data import (  # noqa: TC001 -- needed at runtime for deserialization type resolution
    IngestionData,
)
