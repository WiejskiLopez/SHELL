...
from shell.ingestion.application.ingestion.ingestion.command_handlers.create_ingestion_handler import (
    CreateIngestionHandler,
)
from shell.ingestion.application.ingestion.ingestion.command_handlers.delete_ingestion_handler import (
    DeleteIngestionHandler,
)
from shell.ingestion.application.ingestion.ingestion.command_handlers.update_ingestion_handler import (
...
from shell.ingestion.application.ingestion.ingestion.query_handlers.get_ingestion_by_id_handler import (
    GetIngestionByIdHandler,
)
from shell.ingestion.bootstrap.ingestion.contract_catalog import INGESTION_CONTRACT_CATALOG
from shell.ingestion.bootstrap.ingestion.event_registry import build_ingestion_event_registry
...
from shell.ingestion.infrastructure.ingestion.persistence.sql.repositories.sql_ingestion_repository import (
    SqlIngestionRepository,
)
from shell.ingestion.infrastructure.ingestion.persistence.sql.services.ingestion_query_service import (
...
class IngestionCoreContainer(containers.DeclarativeContainer):
    ...
    command_registry = providers.Object(
        build_command_registry(
            discover_command_types("shell.ingestion.application.ingestion")
        )
    )
