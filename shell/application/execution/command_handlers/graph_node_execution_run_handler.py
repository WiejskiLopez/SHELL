...
Modyfikuje tylko GraphNodeExecution. GraphNodeExecutionState jest tworzony przez
``GraphNodeExecutionCompletedStateHandler`` / ``GraphNodeExecutionFailedStateHandler``
...
class GraphNodeExecutionRunHandler:
    ...
    async def handle(self, run_graph_node_execution_command: RunGraphNodeExecutionCommand) -> str:
        ...
        try:
            ...
            return graph_node_execution_id.value
