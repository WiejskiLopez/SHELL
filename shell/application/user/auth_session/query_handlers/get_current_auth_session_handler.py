...
if TYPE_CHECKING:
    from shell.application.user.auth_session.dto.current_auth_session import (
        CurrentAuthSessionDto,
    )
    from shell.application.user.auth_session.ports.auth_session_query_service import (
