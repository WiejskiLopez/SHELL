...
**Tasker** — executor który na podstawie pliku opisu taska i pliku pipeline generuje strukturę katalogów potrzebną do inicjalizacji wszystkich node'ów taska.
- Przykład opisu taska: `..\tasker\default-tasker\examples\my-task.md`
- Przykład pipeline: `..\tasker\default-tasker\examples\my-task.yaml`
...
**PipelineNode:** `node_dir` = `app.app_node_.node_.node_dir_ / node_name`, `node_name` z `pipeline.yaml`, inicjalizacja przez `_init_pipeline_node(pipeline_node, ...)`
...
Do wszystkich operacji na plikach i katalogach używamy **wyłącznie** klasy `UtilsPath` (`dirnode/utils_path/utils_path.py`). Bezpośrednie wywołania metod `Path` (np. `path.mkdir()`, `path.read_text()`) oraz modułów `shutil`, `os` są niedozwolone.
...
Task sklada sie z: (pipeline posiadajacego autonomiczne procey na osobnych node)
...
To co opisujesz to nie jest zwykły „pipeline”.
To jest:
...
### platform/dirnode/__init__.py
```
# lib package
```

### platform/dirnode/app/__init__.py
```
from dirnode.app.app.app import App
```

### platform/dirnode/app/app/__init__.py
```
from dirnode.app.app.app import App
...
### platform/dirnode/app/app/app.md
```
# Submoduł `app` — klasa `App`

Centralny węzeł DOM dla pojedynczego uruchomienia pipeline. Przechowuje lazy-referencje do wszystkich modułów.
...
### platform/dirnode/app/app/app.py
```
"""app.py
App — central runtime state for a dirnode pipeline run.
...
from dirnode.app.app_node.app_node import AppNode
from dirnode.component.cli.cli.cli import Cli
from dirnode.component.manifest.manifest import Manifest
from dirnode.component.config.config.config import Config
from dirnode.component.placeholders.placeholders import Placeholders
from dirnode.app.app_trace.app_trace import AppTrace
from dirnode.app.app_properties.app_properties import AppProperties
from dirnode.component.result.result import Result
from dirnode.component.runner.runner.runner import Runner
from dirnode.component.runtime.runtime.runtime import Runtime
from dirnode.app.app.internal._init_app import _init_app
from dirnode.app.app.internal._run_app import _run_app
from dirnode.app.app.internal._append_app_config import _append_app_config
...
### platform/dirnode/app/app/internal/__init__.py
```
```

### platform/dirnode/app/app/internal/_append_app_config.py
```
from __future__ import annotations
...
### platform/dirnode/app/app/internal/_archive_app.py
```
from __future__ import annotations
...
### platform/dirnode/app/app/internal/_assert_mode_valid.py
```
...
### platform/dirnode/app/app/internal/_assert_model_resolved.py
```
...
### platform/dirnode/app/app/internal/_finalize_app.py
```
"""_finalize_app.py
...
### platform/dirnode/app/app/internal/_init_app.py
```
"""_init_app.py
...
from dirnode.app.app.internal._init_app_modules import _init_app_modules
from dirnode.app.app.internal._init_app_config import _init_app_config
...
### platform/dirnode/app/app/internal/_init_app_config.py
```
from __future__ import annotations
...
### platform/dirnode/app/app/internal/_init_app_modules.py
```
from __future__ import annotations
...
### platform/dirnode/app/app/internal/_print_app.py
```
"""_print_app.py
...
### platform/dirnode/app/app/internal/_result_app.py
```
"""_result_app.py
...
from dirnode.component.result.result import Result
from dirnode.app.app.internal._print_app import _print_app
...
### platform/dirnode/app/app/internal/_run_app.py
```
"""_run_app.py
...
from dirnode.app.app.internal._archive_app import _archive_app
from dirnode.app.app.internal._finalize_app import _finalize_app
from dirnode.app.app.internal._result_app import _result_app
...
### platform/dirnode/app/app/internal/_save_archive.py
```
﻿"""_save_archive.py
...
### platform/dirnode/app/app_node/__init__.py
```
```

### platform/dirnode/app/app_node/app_node.md
```
...
### platform/dirnode/app/app_node/app_node.py
```
"""app_node.py
AppNode: structured value object for the current node in the context of App.

Analogous to SubNode (which represents a single node in a pipeline),
...
from dirnode.component.locker.locker import Locker
from dirnode.structure.node.node.node import Node
from dirnode.app.app_node.internal._init_app_node import _init_app_node
...
### platform/dirnode/app/app_node/internal/__init__.py
```
```

### platform/dirnode/app/app_node/internal/_init_app_node.py
```
"""_init_app_node.py
...
### platform/dirnode/app/app_node/internal/_init_app_node_node.py
```
```

### platform/dirnode/app/app_properties/__init__.py
```
from dirnode.app.app_properties.app_properties import AppProperties
```

### platform/dirnode/app/app_properties/app_properties.md
```
...
### platform/dirnode/app/app_properties/app_properties.py
```
"""app_properties.py
...
from dirnode.app.app_properties.internal._assert_app_properties_loaded import _assert_app_properties_loaded
...
### platform/dirnode/app/app_properties/internal/__init__.py
```
```

### platform/dirnode/app/app_properties/internal/_assert_app_properties_loaded.py
```
...
### platform/dirnode/app/app_trace/__init__.py
```
```

### platform/dirnode/app/app_trace/app_trace.md
```
# Submoduł `app_trace` — klasa `AppTrace`

Zbiera zdarzenia wykonania (error, warning, success, info) w trakcie pojedynczego uruchomienia pipeline.
...
### platform/dirnode/app/app_trace/app_trace.py
```
"""app_trace.py
AppTrace — collects execution events during a single dirnode pipeline run.
...
from dirnode.app.app_trace.event.event import Event, EventType
...
class AppTrace:
    """Collects execution events for a single pipeline run."""
...
### platform/dirnode/app/app_trace/event/__init__.py
```
```

### platform/dirnode/app/app_trace/event/event.py
```
"""event.py
...
class Event:
    """Single execution event collected during a pipeline run."""
...
### platform/dirnode/component/__init__.py
```
```

### platform/dirnode/component/cli/__init__.py
```
from dirnode.component.cli.cli.cli import Cli
...
### platform/dirnode/component/cli/cli/__init__.py
```
from dirnode.component.cli.cli.cli import Cli
...
### platform/dirnode/component/cli/cli/cli.md
```
...
### platform/dirnode/component/cli/cli/cli.py
```
from __future__ import annotations

from dirnode.component.cli.cli.internal._init_cli import _init_cli
from dirnode.component.cli.cli_properties.cli_properties import CliProperties
from dirnode.component.config.config.config import Config
...
### platform/dirnode/component/cli/cli/internal/__init__.py
```

```

### platform/dirnode/component/cli/cli/internal/_assert_mode_allowed.py
```
...
### platform/dirnode/component/cli/cli/internal/_assert_model_set.py
```
...
### platform/dirnode/component/cli/cli/internal/_assert_node_dir_set.py
```
from __future__ import annotations
...
### platform/dirnode/component/cli/cli/internal/_assert_runner_root_dir_set.py
```
...
### platform/dirnode/component/cli/cli/internal/_assert_source_dir_set.py
```
from __future__ import annotations
...
### platform/dirnode/component/cli/cli/internal/_assert_task_dir_set.py
```
from __future__ import annotations
...
### platform/dirnode/component/cli/cli/internal/_assert_task_name_set.py
```
from __future__ import annotations
...
### platform/dirnode/component/cli/cli/internal/_assert_work_dir_set.py
```
from __future__ import annotations
...
### platform/dirnode/component/cli/cli/internal/_init_cli.py
```
...
### platform/dirnode/component/cli/cli/internal/_init_cli_placeholders.py
```
def _init_cli_placeholders(cli) -> None:
    cli._app.placeholders_.bind_slots(cli.cli_properties_)
```

### platform/dirnode/component/cli/cli/internal/_parse_args.py
```
"""parse_args.py
...
### platform/dirnode/component/cli/cli.md
```
# Moduł `cli`
...
### platform/dirnode/component/cli/cli_properties/__init__.py
```
from dirnode.component.cli.cli_properties.cli_properties import CliProperties
...
### platform/dirnode/component/cli/cli_properties/cli_properties.md
```
...
### platform/dirnode/component/cli/cli_properties/cli_properties.py
```
from __future__ import annotations
...
from dirnode.component.cli.cli.internal._assert_runner_root_dir_set import _assert_runner_root_dir_set
from dirnode.component.cli.cli_properties.internal._init_cli_properties import _init_cli_properties
...
### platform/dirnode/component/cli/cli_properties/internal/__init__.py
```
```

### platform/dirnode/component/cli/cli_properties/internal/_init_cli_properties.py
```
from dirnode.component.cli.cli.internal._assert_node_dir_set import _assert_node_dir_set
from dirnode.component.cli.cli.internal._assert_source_dir_set import _assert_source_dir_set
from dirnode.component.cli.cli.internal._assert_task_name_set import _assert_task_name_set
from dirnode.component.cli.cli.internal._assert_task_dir_set import _assert_task_dir_set
from dirnode.component.cli.cli.internal._assert_model_set import _assert_model_set
from dirnode.component.cli.cli.internal._assert_work_dir_set import _assert_work_dir_set
...
### platform/dirnode/component/command/__init__.py
```
```

### platform/dirnode/component/command/command.py
```
"""command.py
...
### platform/dirnode/component/config/__init__.py
```
```

### platform/dirnode/component/config/config/__init__.py
```

```

### platform/dirnode/component/config/config/config.py
```
"""config.py
...
from dirnode.component.config.config.internal._append_config_value import _append_config_value
from dirnode.component.config.config.internal._assert_config_path_set import _assert_config_path_set
from dirnode.component.config.config.internal._assert_model_set import _assert_model_set
from dirnode.component.config.config.internal._init_config import _init_config
...
### platform/dirnode/component/config/config/internal/__init__.py
```
```

### platform/dirnode/component/config/config/internal/_append_config_value.py
```
from __future__ import annotations
...
### platform/dirnode/component/config/config/internal/_assert_config_body_loaded.py
```
...
### platform/dirnode/component/config/config/internal/_assert_config_path_set.py
```
...
### platform/dirnode/component/config/config/internal/_assert_model_set.py
```
...
### platform/dirnode/component/config/config/internal/_init_config.py
```
from __future__ import annotations
...
### platform/dirnode/component/config/internal/__init__.py
```
```

### platform/dirnode/component/locker/__init__.py
```
# lib/lock package
```

### platform/dirnode/component/locker/internal/__init__.py
```
```

### platform/dirnode/component/locker/internal/_acquire_node_dir_lock.py
```
...
from dirnode.component.locker.internal._is_stale import _is_stale
from dirnode.component.locker.internal._lock_error import LockError
...
### platform/dirnode/component/locker/internal/_assert_lock_path_set.py
```
...
### platform/dirnode/component/locker/internal/_is_stale.py
```
"""_is_stale.py
...
from dirnode.component.locker.internal._pid_alive import _pid_alive
from dirnode.utils.path.path import Path, PathType
...
### platform/dirnode/component/locker/internal/_lock_error.py
```
class LockError(RuntimeError):
    """Raised when the node is already locked by another live process."""
```

### platform/dirnode/component/locker/internal/_pid_alive.py
```
"""_pid_alive.py
...
### platform/dirnode/component/locker/internal/_release_node_dir_lock.py
```
from dirnode.utils.path.path import PathType
"""release_lock.py
...
### platform/dirnode/component/locker/locker.py
```
"""locker.py
...
from dirnode.component.locker.internal._acquire_node_dir_lock import acquire_node_dir_lock
from dirnode.component.locker.internal._release_node_dir_lock import release_node_dir_lock
from dirnode.component.locker.internal._lock_error import LockError
from dirnode.component.locker.internal._assert_lock_path_set import _assert_lock_path_set
from dirnode.component.result.result import Result
...
### platform/dirnode/component/manifest/__init__.py
```
```

### platform/dirnode/component/manifest/internal/__init__.py
```
```

### platform/dirnode/component/manifest/internal/_assert_manifest_body_loaded.py
```
...
### platform/dirnode/component/manifest/internal/_assert_manifest_not_empty.py
```
...
### platform/dirnode/component/manifest/internal/_assert_manifest_path_set.py
```
...
### platform/dirnode/component/manifest/internal/_load_manifest.py
```

from dirnode.component.manifest.manifest import Manifest
from dirnode.utils.path.path import Path, PathType
from dirnode.constants.constants import MANIFEST_YAML
...
### platform/dirnode/component/manifest/internal/_manifest_description.py
```
import yaml
...
### platform/dirnode/component/manifest/internal/_manifest_name.py
```
import yaml
...
### platform/dirnode/component/manifest/internal/_manifest_version.py
```
import yaml
...
### platform/dirnode/component/manifest/internal/_validate_manifest.py
```
import yaml
...
### platform/dirnode/component/manifest/manifest.md
```
ten moul i ta klasa to kontener na plik manifest
```

### platform/dirnode/component/manifest/manifest.py
```
"""manifest.py
...
from dirnode.component.manifest.internal._manifest_name import get_manifest_name
from dirnode.component.manifest.internal._manifest_version import get_manifest_version
from dirnode.component.manifest.internal._manifest_description import get_manifest_description
from dirnode.component.manifest.internal._assert_manifest_body_loaded import _assert_manifest_body_loaded
from dirnode.component.manifest.internal._assert_manifest_path_set import _assert_manifest_path_set
from dirnode.component.manifest.internal._assert_manifest_not_empty import _assert_manifest_not_empty
from dirnode.constants.constants import MANIFEST_YAML
...
### platform/dirnode/component/message/__init__.py
```
from dirnode.component.message.message.message import Message
from dirnode.component.message.message_envelope.message_envelope import MessageEnvelope
from dirnode.component.message.message_meta.message_meta import MessageMeta
from dirnode.component.message.message_status.message_status import MessageStatus
from dirnode.component.message.message_type.message_type import MessageType
```

### platform/dirnode/component/message/message/__init__.py
```
from dirnode.component.message.message.message import Message
```

### platform/dirnode/component/message/message/message.py
```
from __future__ import annotations
...
class Message:
    ...
    @property
    def message_(self) -> str:
        return self._message
```

### platform/dirnode/component/message/message_envelope/__init__.py
```
from dirnode.component.message.message_envelope.message_envelope import MessageEnvelope
```

### platform/dirnode/component/message/message_envelope/message_envelope.py
```
from __future__ import annotations
...
class MessageEnvelope:
    ...
    __slots__ = ("_message_meta", "_message")
...
### platform/dirnode/component/message/message_meta/__init__.py
```
from dirnode.component.message.message_meta.message_meta import MessageMeta
```

### platform/dirnode/component/message/message_meta/message_meta.py
```
from __future__ import annotations
...
### platform/dirnode/component/message/message_status/__init__.py
```
from dirnode.component.message.message_status.message_status import MessageStatus
```

### platform/dirnode/component/message/message_status/message_status.py
```
from __future__ import annotations
...
### platform/dirnode/component/message/message_type/__init__.py
```
from dirnode.component.message.message_type.message_type import MessageType
```

### platform/dirnode/component/message/message_type/message_type.py
```
from __future__ import annotations
...
### platform/dirnode/component/placeholders/__init__.py
```
from dirnode.component.placeholders.placeholders import Placeholders
```

### platform/dirnode/component/placeholders/internal/__init__.py
```
```

### platform/dirnode/component/placeholders/internal/_add_placeholder.py
```
from dirnode.constants.constants import DIR_OUTPUT, DIR_INPUT, DIR_ARCHIVE, DIR_TEMP
...
### platform/dirnode/component/placeholders/internal/_apply.py
```
...
### platform/dirnode/component/placeholders/internal/_assert_no_unresolved_placeholders.py
```
import re
...
### platform/dirnode/component/placeholders/internal/_bind_dict.py
```
from dirnode.component.placeholders.internal._add_placeholder import _add_placeholder
from dirnode.component.placeholders.internal._set_placeholder import _set_placeholder
...
### platform/dirnode/component/placeholders/internal/_bind_slots.py
```
...
### platform/dirnode/component/placeholders/internal/_set_placeholder.py
```
...
### platform/dirnode/component/placeholders/internal/_wrap.py
```
...
### platform/dirnode/component/placeholders/placeholders.py
```
"""placeholders.py
...
from dirnode.component.placeholders.internal._add_placeholder import _add_placeholder
from dirnode.component.placeholders.internal._apply import _apply
from dirnode.component.placeholders.internal._assert_no_unresolved_placeholders import _assert_no_unresolved_placeholders
from dirnode.component.placeholders.internal._bind_dict import _bind_dict
from dirnode.component.placeholders.internal._bind_slots import _bind_slots
from dirnode.component.placeholders.internal._set_placeholder import _set_placeholder
from dirnode.component.placeholders.internal._wrap import _wrap
...
### platform/dirnode/component/process/__init__.py
```
from dirnode.component.process.process.process import Process
```

### platform/dirnode/component/process/process/internal/_init_process.py
```
from __future__ import annotations
...
### platform/dirnode/component/process/process/internal/_init_process_command.py
```
from __future__ import annotations

from dirnode.component.process.process_command.process_command import ProcessCommand
...
### platform/dirnode/component/process/process/internal/_run_process.py
```
from __future__ import annotations
...
### platform/dirnode/component/process/process/process.py
```
"""process.py
...
from dirnode.component.process.process_command.process_command import ProcessCommand
from dirnode.component.process.process.internal._init_process import _init_process
from dirnode.component.process.process.internal._run_process import _run_process
...
### platform/dirnode/component/process/process_command/internal/_init_process_command.py
```
from __future__ import annotations
...
### platform/dirnode/component/process/process_command/process_command.py
```
"""process_command.py
...
from dirnode.component.process.process_command.internal._init_process_command import _init_process_command
...
### platform/dirnode/component/prompt/__init__.py
```
from dirnode.component.prompt.prompt.prompt import Prompt
```

### platform/dirnode/component/prompt/prompt/__init__.py
```
from dirnode.component.prompt.prompt.prompt import Prompt
```

### platform/dirnode/component/prompt/prompt/internal/_init_prompt.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt/prompt.py
```
from dirnode.utils.path.path import PathType
from __future__ import annotations
...
from dirnode.component.prompt.prompt.internal._init_prompt import _init_prompt
from dirnode.component.prompt.prompt_cli.prompt_cli import PromptCli
from dirnode.component.prompt.prompt_input.prompt_input import PromptInput
...
from dirnode.component.prompt.prompt_task.prompt_task import PromptTask
...
### platform/dirnode/component/prompt/prompt_cli/__init__.py
```
from dirnode.component.prompt.prompt_cli.prompt_cli import PromptCli
```

### platform/dirnode/component/prompt/prompt_cli/internal/__init__.py
```
```

### platform/dirnode/component/prompt/prompt_cli/internal/_init_prompt_cli.py
```
from dirnode.component.prompt.prompt_type.prompt_type import PromptType
...
### platform/dirnode/component/prompt/prompt_cli/prompt_cli.py
```
"""prompt_cli.py
...
from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_cli.internal._init_prompt_cli import _init_prompt_cli
...
### platform/dirnode/component/prompt/prompt_input/__init__.py
```
from dirnode.component.prompt.prompt_input.prompt_input import PromptInput
...
### platform/dirnode/component/prompt/prompt_input/internal/_init_prompt_input.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt_input/internal/_prompt.py
```
...
### platform/dirnode/component/prompt/prompt_input/prompt_input.py
```
from __future__ import annotations

from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_input.internal._init_prompt_input import _init_prompt_input
from dirnode.component.prompt.prompt_input.internal._prompt import _prompt
...
### platform/dirnode/component/prompt/prompt_role/__init__.py
```
from dirnode.component.prompt.prompt_role.prompt_role import PromptRole
```

### platform/dirnode/component/prompt/prompt_role/internal/__init__.py
```
```

### platform/dirnode/component/prompt/prompt_role/internal/_init_prompt_role.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt_role/internal/_prompt.py
```
...
### platform/dirnode/component/prompt/prompt_role/prompt_role.py
```
"""prompt_role.py
...
from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_role.internal._init_prompt_role import _init_prompt_role
from dirnode.component.prompt.prompt_role.internal._prompt import _prompt
...
### platform/dirnode/component/prompt/prompt_skill/__init__.py
```
```

### platform/dirnode/component/prompt/prompt_skill/internal/__init__.py
```
```

### platform/dirnode/component/prompt/prompt_skill/internal/_init_prompt_skill.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt_skill/internal/_prompt.py
```
...
### platform/dirnode/component/prompt/prompt_skill/prompt_skill.py
```
"""prompt_skill.py
...
from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_skill.internal._init_prompt_skill import _init_prompt_skill
from dirnode.component.prompt.prompt_skill.internal._prompt import _prompt
...
### platform/dirnode/component/prompt/prompt_system/__init__.py
```
from dirnode.component.prompt.prompt_system.prompt_system import PromptSystem
```

### platform/dirnode/component/prompt/prompt_system/internal/__init__.py
```
```

### platform/dirnode/component/prompt/prompt_system/internal/_init_prompt_system.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt_system/internal/_prompt.py
```
...
### platform/dirnode/component/prompt/prompt_system/prompt_system.py
```
"""prompt_system.py
...
from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_system.internal._init_prompt_system import _init_prompt_system
from dirnode.component.prompt.prompt_system.internal._prompt import _prompt
...
### platform/dirnode/component/prompt/prompt_task/__init__.py
```
from dirnode.component.prompt.prompt_task.prompt_task import PromptTask
...
### platform/dirnode/component/prompt/prompt_task/internal/_init_prompt_task.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt/prompt_task/internal/_prompt.py
```
...
### platform/dirnode/component/prompt/prompt_task/prompt_task.py
```
from __future__ import annotations

from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_task.internal._init_prompt_task import _init_prompt_task
from dirnode.component.prompt.prompt_task.internal._prompt import _prompt
...
### platform/dirnode/component/prompt/prompt_type/__init__.py
```
from dirnode.component.prompt.prompt_type.prompt_type import PromptType
```

### platform/dirnode/component/prompt/prompt_type/prompt_type.py
```
"""prompt_type.py
...
### platform/dirnode/component/prompt_file/__init__.py
```
# dirnode/prompt_file package
from dirnode.component.prompt_file.prompt_file import PromptFile
from dirnode.component.prompt.prompt_type.prompt_type import PromptType
__all__ = ['PromptFile', 'PromptType']
```

### platform/dirnode/component/prompt_file/internal/__init__.py
```
# dirnode/prompt_file/internal package
```

### platform/dirnode/component/prompt_file/internal/_init_prompt_file.py
```
from dirnode.utils.path.path import PathType
from __future__ import annotations


from dirnode.component.prompt_file.internal._save_prompt_file import _save_prompt_file
from dirnode.component.prompt.prompt_type.prompt_type import PromptType
...
### platform/dirnode/component/prompt_file/internal/_save_prompt_file.py
```
from __future__ import annotations
...
### platform/dirnode/component/prompt_file/prompt_file.py
```
from dirnode.utils.path.path import PathType
"""prompt_file.py
...
from dirnode.component.prompt_file.internal._init_prompt_file import _init_prompt_file
from dirnode.component.prompt_file.internal._save_prompt_file import _save_prompt_file
from dirnode.component.prompt.prompt_type.prompt_type import PromptType
...
### platform/dirnode/component/result/__init__.py
```
from dirnode.component.result.result import Result
...
### platform/dirnode/component/result/internal/__init__.py
```
from dirnode.component.result.internal._save_result import _save_result

__all__ = ["_save_result"]
```

### platform/dirnode/component/result/internal/_save_result.py
```
"""_save_result.py
Responsible for one thing: persisting the pipeline result to .node/result/.
...
### platform/dirnode/component/result/result.py
```
"""result.py
Result — singleton execution result for a single dirnode pipeline run.
...
__slots__:
    ...
    status          — semantyczny wynik z perspektywy pipeline
...
Rozróżnienie status vs returncode:
    ...
    status     — semantyczny wynik pipeline (returncode=0 może dać status=waiting)
"""
...
class Result:
    """Singleton execution result for a single pipeline run."""
...
### platform/dirnode/component/runner/__init__.py
```
from dirnode.component.runner.runner.runner import Runner
```

### platform/dirnode/component/runner/runner/internal/__init__.py
```
```

### platform/dirnode/component/runner/runner/internal/_clean_node.py
```
"""_clean_node.py
...
### platform/dirnode/component/runner/runner/internal/_init_runner.py
```
"""_init_runner.py
...
### platform/dirnode/component/runner/runner/internal/_print_help.py
```
"""_print_help.py
...
### platform/dirnode/component/runner/runner/internal/_print_version.py
```
"""_print_version.py
...
### platform/dirnode/component/runner/runner/internal/_run_runner.py
```
"""_run_runner.py
...
from dirnode.component.runner.runner.internal._clean_node import _clean_node
from dirnode.component.runner.runner.internal._print_help import _print_help
from dirnode.component.runner.runner.internal._print_version import _print_version
